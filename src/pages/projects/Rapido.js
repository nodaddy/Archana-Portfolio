        ...
        <div align="center" id="rapido">
            ...
            <Col lg={{span:12}} xs={{span:24}} style={{paddingTop:'50px'}}> 
                ...
                <p align="left" className="rapidoHp" style={{fontSize:'17px'}}>
                    ...
                    <br/>
                    <br/>
                    <span style={{fontFamily:'Nanum Pen Script', fontSize:'26px'}}>Accept / Yes / OK / Accept/ Haan/ Howdu/ Sari ride eduthukaran</span>
                    <br/>
                    <span style={{fontFamily:'Nanum Pen Script', fontSize:'26px'}}>Ride Reject / No / Decline / Reject Ride/ Nahi/ Illai/ Illa/ Beda</span>
            ...
            <br/>
                ...
                <p align="left" className="rapidoHb" style={{fontSize:'17px', fontFamily:'Raleway'}}>
                    ...
                    <br/>
                    <br/>
                    <p style={{fontFamily:'Nanum Pen Script', fontSize:'26px'}}>
