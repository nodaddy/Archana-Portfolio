...
export default function Home(){
    return (
      <div id="home" align="center"> 
          <div className="home-title" style={{color: '#796b6d', fontFamily:'Palatino-Roman', fontSize:'50px', marginBottom:'15px'}}>
              Designing through the night.
         </div>
         <div className="home-title" style={{marginTop:'-30px',color: '#796b6d', fontFamily:'Palatino-Roman', fontSize:'50px', marginBottom:'18px'}}>
